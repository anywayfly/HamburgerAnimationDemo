...
class HumburgerView: UIButton {
    ...
    override init(frame: CGRect) {
        ...
        self.top.path = strokePath
        self.middle.path = outline
        self.bottom.path = strokePath
    ...
    var showMenu: Bool = false {
        didSet {
            ...
            self.middle.mxd_applyAnimation(strokeStart)
            self.middle.mxd_applyAnimation(strokeEnd)
            ...
            self.top.mxd_applyAnimation(topTransform)
            self.bottom.mxd_applyAnimation(bottomTransform)
...
extension CALayer {
    ...
    func mxd_applyAnimation(animation: CABasicAnimation) {
